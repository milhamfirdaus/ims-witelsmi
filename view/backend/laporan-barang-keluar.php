        ...
        <div class="content">
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                  <h4 class="m-t-0 header-title" style="text-align: center;"><b>Barang Keluar</b></h4>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th width ="5%"><?=$i?></th>
                        <th width ="7%"><?=$data->nik?></th>
                        <th width ="10%"><?=$data->nama?></th>
                        <th width ="20%"><?=$data->nama_barang?></th>
                        <th width ="10%"><?=$data->ip?></th>
                        <th width ="10%"><?=$data->tanggal_keluar?></th>
                        <th width ="10%"><?=$data->keterangan?></th>
                    </tr>
                    <?php
                    $i++;
                    }
