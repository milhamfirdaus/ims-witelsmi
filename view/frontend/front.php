...
<div class="w3-row">
  <div class="w3-half w3-dark-grey w3-container w3-center" style="height:700px">
    ...
    <div class="w3-padding-64">
      <a href="<?=set_url('admin/access/login');?>" class="w3-button w3-blue-grey w3-block w3-hover-white w3-padding-16">Login</a>
      <a href="#contact" class="w3-button w3-white w3-block w3-hover-black w3-padding-16">Contact</a>
    </div>
  </div>
  <div class="w3-half w3-white w3-container" style="height:700px">
    <div class="w3-padding-64 w3-center">
      <h1>PT. TELKOM WITEL SUKABUMI</h1>
      <img src="<?php echo get_directory(dirname(__FILE__),'/backend/assets/');?>img/logo.png" class="w3-margin w3-circle" alt="Person" style="width:50%">
      <div class="w3-left-align w3-padding-large">
        <p>Aplikasi Ini merupakan Sarana Inventarisasi dan Pengolahan data inventaris</p>
      </div>
    </div>
  </div>
</div>
