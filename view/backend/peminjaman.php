          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <p class="text-muted font-13">
                <code>Cari,input,lihat,hapus</code> Data Barang Keluar</p>
                  ...
                  <fieldset>
                    ...
                    <div class="col-sm-6" id="form-input">
                        <div class="form-group col-md-12">
                            <label>NIK</label>
                            <input name="nik" list="nik" class="form-control" id="" placeholder="" required=""/>
                            <datalist id="nik">
                              <option></option>
                            </datalist>
                        </div>
                        <div class="form-group col-md-12">
                            <label>Witel</label>
                            <input name="id-witel" type="text" class="form-control" id="id-witel" placeholder="" required/>
                        </div>
                        <div class="form-group col-md-6">
                            <label>IP</label>
                            <input class="form-control" type="text" id="IP" name="IP" placeholder="IP">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Jumlah</label>
                            <input class="form-control" type="number" id="jumlah-barang" name="jumlah-barang"  min="0" value="0" required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label>Tanggal Keluar</label>
                            <input class="form-control" data-mask="date" placeholder="DD/MM/YYYY" id="tanggal-keluar" name="tanggal-keluar">
                        </div>
                        <div class="form-group col-md-12">
