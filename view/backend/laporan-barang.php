        ...
        <div class="content">
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                  <h4 class="m-t-0 header-title" style="text-align: center;"><b>Inventaris</b></h4>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th width ="5%"><?=$i?></th>
                        <th width ="15%"><?=$data->nama_barang?></th>
                        <th width ="10%"><?=$data->serial?></th>
                        <th width ="10%"><?=$data->nama_jenis?></th>
                        <th width ="10%"><?=$data->jumlah?></th>
                        <th width ="15%"><?=$data->tanggal_masuk?></th>
                        <th width ="10%"><?=$data->kondisi?></th>
                    </tr>
                    <?php
                    $i++;
                    }
