<?php
	...
	function get_directory($path,$dir_file){
		global $SConfig;
	...
	function title(){
		...
		$array = array( 'dashboard' => 'Halaman Utama',
						'barang' => 'Barang',
						'barang/jenis'=>'Jenis',
						'user'=>'User',
						'witel'=>'Witel & Datel',
		...
		if(array_key_exists($_this->uri->segment(2), $array)){
			return $array[$_this->uri->segment(2)].' | '.'Aplikasi Inventaris';
		}
	}
	...
	function header_title(){
		...
		$array = array( 'dashboard' => 'Dashboard',
						...
						'kerusakan/riwayat'=>'Kerusakan Barang',
					);
		$title = NULL;
		if(array_key_exists($_this->uri->segment(2), $array)){
			return 'Tabel '.$array[$_this->uri->segment(2)];
		}
	}
